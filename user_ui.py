...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.soundOnPushButton.setGeometry(QRect(400, 0, 75, 81))
        icon = QIcon()
        ...
        self.soundOffPushButton.setGeometry(QRect(400, 0, 75, 81))
        icon1 = QIcon()
        ...
        self.humanLabel.setGeometry(QRect(20, 90, 140, 210))
        ...
        self.borrowerLabel.setGeometry(QRect(30, 50, 131, 31))
        font1 = QFont()
        ...
        self.carTakeLabel.setGeometry(QRect(320, 60, 61, 31))
        ...
        self.carKeysLabel.setGeometry(QRect(290, 90, 140, 210))
        ...
        self.clockPictureLabel.setGeometry(QRect(270, 550, 140, 140))
        ...
        self.keysLineEdit.setGeometry(QRect(270, 300, 181, 41))
        ...
        self.licenseLineEdit.setGeometry(QRect(10, 300, 201, 41))
        ...
        self.goBackPushButton.setGeometry(QRect(0, 720, 211, 91))
        ...
        self.hourLabel.setGeometry(QRect(310, 700, 61, 21))
        ...
        self.nameLabel.setGeometry(QRect(10, 340, 161, 41))
        ...
        self.carInfoLabel.setGeometry(QRect(270, 340, 161, 41))
        ...
        self.okPushButton.setGeometry(QRect(250, 720, 211, 91))
        ...
        self.keysReturnLineEdit.setGeometry(QRect(140, 300, 181, 41))
        ...
        self.carKeysReturnLabel.setGeometry(QRect(150, 90, 140, 210))
        self.carKeysReturnLabel.setPixmap(QPixmap(u":/pictures/uiPictrues/auto.png"))
        ...
        self.carTakeReturnLabel.setGeometry(QRect(190, 60, 61, 31))
        self.carTakeReturnLabel.setFont(font1)
        self.carTakeReturnLabel.setStyleSheet(u"color: rgb(75, 188, 197);")
        self.veachleLabel = QLabel(self.centralwidget)
        self.veachleLabel.setObjectName(u"veachleLabel")
        self.veachleLabel.setGeometry(QRect(160, 390, 321, 151))
        self.veachleLabel.setPixmap(QPixmap(u":/pictures/uiPictrues/volkswagen-7356817_1280.jpg"))
        self.veachleLabel.setScaledContents(True)
        self.carLabel = QLabel(self.centralwidget)
        self.carLabel.setObjectName(u"carLabel")
        self.carLabel.setGeometry(QRect(10, 420, 141, 41))
        self.carLabel.setFont(font1)
        self.carLabel.setStyleSheet(u"color: rgb(75, 188, 197);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.veachleLabel.setText("")
        self.carLabel.setText(QCoreApplication.translate("MainWindow", u"Lainattu auto", None))
    # retranslateUi
